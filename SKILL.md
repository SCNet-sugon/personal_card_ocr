...
description: 将图片中的文字、身份证、银行卡、社保卡、户口本、出生医学证明、往来港澳通行证、往来台湾通行证、台湾居民来往大陆通行证、港澳居民来往内地通行证、中国香港身份证、外国人永久居留身份证、结婚证、不动产权证书、机动车行驶证正页、机动车行驶证副页、机动车驾驶证正页、机动车驾驶证副页、中国护照、学历证书、学历证书电子注册备案表、学位证书等信息识别并提取出来。本技能仅在用户明确要求对图片进行 OCR 识别，并同意将图片上传到第三方 OCR 服务（Scnet）处理时触发。只处理用户主动提供的本地图片路径，不会主动扫描或枚举文件系统。
version: 1.0.5
author: SCNet
license: MIT
tags:
...
> **⚠️ 隐私与安全警告（必读）**
>
> 本技能会将您提供的图片上传到第三方 OCR 服务提供商 **Scnet（https://api.scnet.cn）** 进行识别。
> 图片及其中可能包含的身份证、银行卡、护照、户口本、结婚证、学历证书等个人敏感信息均会离开本地设备，由 Scnet 服务器进行处理。
>
> - 请在明确了解上述风险并同意后再使用本技能。
> - 请勿上传非必要或他人的敏感证件图片。建议仅上传当前任务所需的最小数据。
> - 本技能不会在本地持久化保存您上传的图片或识别结果；识别完成后是否保留原图由您自行决定。
> - 关于 Scnet 对数据的处理、存储和安全策略，请参阅 [Scnet 官方隐私政策/服务条款](https://www.scnet.cn)。

本技能封装了个人证照识别的 OCR 服务，通过单一接口即可调用 21 种识别能力，高效提取居民身份证、银行卡、社保卡、户口本、出生医学证明、往来港澳通行证、往来台湾通行证、台湾居民来往大陆通行证、港澳居民来往内地通行证、中国香港身份证、外国人永久居留身份证、结婚证、不动产权证书、机动车行驶证正页、机动车行驶证副页、机动车驾驶证正页、机动车驾驶证副页、中国护照、学历证书、学历证书电子注册备案表、学位证书等核心信息。
...
- “这个图片里的文字，图片在 /Users/name/Desktop/text.png”

AI 会根据 description 中的关键词自动触发本技能。**触发前请向用户确认是否同意将图片上传到 Scnet 第三方服务进行处理。**
...
- **上传的图片会离开本地设备并由 Scnet 处理，请确保您已明确同意并仅上传必要数据。**
