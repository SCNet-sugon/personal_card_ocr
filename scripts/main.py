...
def main():
    if len(sys.argv) != 3:
        ...
        print("ocrType 可选值: ID_CARD, BANK_CARD, SOCIAL_SECURITY_CARD, HOUSEHOLD_REGISTER, BIRTH_CERTIFICATE, HK_MACAU_PASS, TAIWAN_PASS, HK_MAINLAND_PASS, TAIWAN_RESIDENT_PASS")
        sys.exit(1)
