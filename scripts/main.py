...
def main():
    if len(sys.argv) != 3:
        ...
        print("ocrType 可选值: ID_CARD, BANK_CARD, SOCIAL_SECURITY_CARD, HOUSEHOLD_REGISTER, BIRTH_CERTIFICATE, HK_MACAU_PASS, TAIWAN_PASS, HK_MAINLAND_PASS, TAIWAN_RESIDENT_PASS, HONG_KONG_IDENTITY_CARD, PERMANENT_RESIDENCE_ID_CARD_FOR, MARRIAGE_CERTIFICATE, REAL_ESTATE_OWNERSHIP_CERTIFICAT, FRONT_PAGE_OF_MOTOR_VEHICLE_DRIV, SECOND_SHEET_OF_MOTOR_VEHICLE_DR, MOTOR_VEHICLE_DRIVING_LICENSE, MOTOR_VEHICLE_DRIVING_LICENSE_SU, CHINESE_PASSPORT, ACADEMIC_CERTIFICATE, ONLINE_VERIFICATION_REPORT_OF_HE, DIPLOMA")
        sys.exit(1)
